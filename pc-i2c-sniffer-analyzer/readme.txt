...
обновить статистику, ввод - переключиться на выбранный канал, q - выйти.
Для выбора канала при переключении необходимо цифрами ввести ID нужного узла
и нажать клавишу ввода. Для возвращения в меню с общей статистикой необходимо
ввести 0 и нажать клавишу ввода.
